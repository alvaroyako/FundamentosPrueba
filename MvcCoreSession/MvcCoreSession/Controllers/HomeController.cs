    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult EjemploSession(string accion)
        {
            if (accion == "almacenar")
            {
                ...
                //Mediante helper covertimos objeto persona a string json
            ...
            {
                //Extraemos la informacion de byte[] de session
                Persona persona = HttpContext.Session.GetObject<Persona>("PERSONA");
        ...
        public IActionResult ColeccionSession(string accion)
        {
                ...
                List<Persona> personas = new List<Persona>
            {
                ...
                new Persona{Nombre="Pepa", Edad=69, Hora=DateTime.Now.ToLongTimeString()},
                new Persona{Nombre="elpepe", Edad=13, Hora=DateTime.Now.ToLongTimeString()}
             };
